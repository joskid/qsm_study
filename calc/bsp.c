...
int BSP_eval( double operand1, int oper, double operand2 ) 
{
   ...
   switch( oper ) 
   {
      ...
      case KEY_MULT: 
         ...
         break;
      case KEY_DIVIDE: 
         if( ( operand2 < -1e-30 ) ||( 1e-30 < operand2 ) ) result = operand1 / operand2;
         else 
         {
   ...
   if( ok ) 
   {
      if( ( -0.000001 < result ) &&( result < 0.000001 ) ) result = 0.0;

      if( ( -99999999.0 < result ) &&( result < 99999999.0 ) ) sprintf( l_display, "%9.6g", result );
      else 
      {
...
/*..........................................................................*/
void BSP_message( char const *msg ) { printf( "%s", msg ); }
/*..........................................................................*/
