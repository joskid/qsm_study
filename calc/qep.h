...
*/
#define QM_SUPER_SUB(host_) ((Q_MSM_UPCAST(me))->temp.obj = (host_), (QState)Q_RET_SUPER_SUB)
...
* @include qep_qtran.c
*/
#define Q_TRAN(target_)  ((Q_MSM_UPCAST(me))->temp.fun = Q_STATE_CAST(target_), (QState)Q_RET_TRAN)
...
* @include qep_qhist.c
*/
#define Q_TRAN_HIST(hist_)  ((Q_MSM_UPCAST(me))->temp.fun = (hist_), (QState)Q_RET_TRAN_HIST)
...
* @include qep_qtran.c
*/
#define Q_SUPER(super_)    ((Q_MSM_UPCAST(me))->temp.fun = Q_STATE_CAST(super_), (QState)Q_RET_SUPER)
